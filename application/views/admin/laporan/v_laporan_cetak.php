...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .divider-dashed { border-top: 1px dashed #999; margin: 10px 0; }
    ...
    <div class="page">
        ...
        <div class="stats-row">
            <div class="stat-box">
                ...
                <div class="s-value"><?= $total_trx ?></div>
            </div>
            <div class="stat-box">
                <div class="s-label">Total Omzet</div>
                <div class="s-value blue" style="font-size:13px;">Rp <?= number_format($total_omzet, 0, ',', '.') ?></div>
            </div>
            <div class="stat-box">
                <div class="s-label">Rata-rata / Trx</div>
                <div class="s-value" style="font-size:13px;">Rp <?= number_format(($total_trx > 0 ? $total_omzet / $total_trx : 0), 0, ',', '.') ?></div>
            </div>
        </div>
        ...
        <div class="section-title">&#x1F465; Kinerja per Kasir</div>
        <table>
            <thead>
                <tr>
                    <th>Nama Kasir</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?= $pk['jumlah_trx'] ?> trx</td>
        ...
        <!-- RIWAYAT TRANSAKSI -->
        <div class="section-title">&#x1F4CB; Riwayat Transaksi (<?= count($sales) ?>)</div>
        <table>
            <thead>
                <tr>
                    <th class="text-center" style="width:28px;">#</th>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr><td colspan="7" class="text-center" style="padding:20px; color:#9ca3af;">Tidak ada transaksi di periode ini</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
        ...
        <div class="signatures">
            ...
            <div class="sign-box">
                ...
                <div class="sign-space"></div>
                <div class="sign-name">Eki Erma Yunisa</div>
                <div style="font-size:10px; color:#555;">Admin</div>
            </div>
        </div>
