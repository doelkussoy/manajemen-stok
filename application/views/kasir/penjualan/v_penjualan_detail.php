...
<style>
    ...
    <div class="page-title-row">
        ...
        <a href="<?= site_url('kasir/penjualan') ?>" class="btn-back"><i class="fas fa-arrow-left"></i> Kembali ke Riwayat</a>
    </div>
                    ...
                    <table class="items-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong style="color:#111827;"><?= htmlspecialchars($d['nama_produk'] ?? '-') ?></strong><span style="font-size:11px; color:#9ca3af; margin-left:4px;">(<?= $d['satuan'] ?? '' ?>)</span></td>
                            ...
                            <?php endforeach; ?>
                            <tr class="total-row"><td colspan="5" style="text-align:right; padding-right:20px;">TOTAL</td><td style="font-size:15px;">Rp <?= number_format($header['total_harga'], 0, ',', '.') ?></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
